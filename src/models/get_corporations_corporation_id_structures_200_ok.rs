...
pub struct GetCorporationsCorporationIdStructures200Ok {
  ...
  #[serde(rename = "next_reinforce_weekday")]
  next_reinforce_weekday: Option<i32>,
  ...
  #[serde(rename = "reinforce_weekday")]
  reinforce_weekday: Option<i32>,
...
impl GetCorporationsCorporationIdStructures200Ok {
  /// 200 ok object
  pub fn new(corporation_id: i32, profile_id: i32, reinforce_hour: i32, state: String, structure_id: i64, system_id: i32, type_id: i32) -> GetCorporationsCorporationIdStructures200Ok {
  ...
  pub fn set_next_reinforce_weekday(&mut self, next_reinforce_weekday: i32) {
    self.next_reinforce_weekday = Some(next_reinforce_weekday);
  }

  pub fn with_next_reinforce_weekday(mut self, next_reinforce_weekday: i32) -> GetCorporationsCorporationIdStructures200Ok {
    self.next_reinforce_weekday = Some(next_reinforce_weekday);
    self
  }

  pub fn next_reinforce_weekday(&self) -> Option<&i32> {
    self.next_reinforce_weekday.as_ref()
  }

  pub fn reset_next_reinforce_weekday(&mut self) {
    self.next_reinforce_weekday = None;
  }
  ...
  pub fn reinforce_hour(&self) -> &i32 {
    &self.reinforce_hour
  }


  pub fn set_reinforce_weekday(&mut self, reinforce_weekday: i32) {
    self.reinforce_weekday = Some(reinforce_weekday);
  }

  pub fn with_reinforce_weekday(mut self, reinforce_weekday: i32) -> GetCorporationsCorporationIdStructures200Ok {
    self.reinforce_weekday = Some(reinforce_weekday);
    self
  }

  pub fn reinforce_weekday(&self) -> Option<&i32> {
    self.reinforce_weekday.as_ref()
  }

  pub fn reset_reinforce_weekday(&mut self) {
    self.reinforce_weekday = None;
  }
