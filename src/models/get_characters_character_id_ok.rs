...
pub struct GetCharactersCharacterIdOk {
  ...
  /// ancestry_id integer
  #[serde(rename = "ancestry_id")]
  ancestry_id: Option<i32>,
...
impl GetCharactersCharacterIdOk {
  ...
  pub fn set_ancestry_id(&mut self, ancestry_id: i32) {
    self.ancestry_id = Some(ancestry_id);
  }

  pub fn with_ancestry_id(mut self, ancestry_id: i32) -> GetCharactersCharacterIdOk {
    self.ancestry_id = Some(ancestry_id);
    self
  }

  pub fn ancestry_id(&self) -> Option<&i32> {
    self.ancestry_id.as_ref()
  }

  pub fn reset_ancestry_id(&mut self) {
    self.ancestry_id = None;
  }
